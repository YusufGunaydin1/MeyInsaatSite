# MEY'den beklenen bilgiler — sitenin "gerçek" sayılması için

> Site tam yapıdadır ve tüm eksik bilgiler görünür **[Bilgi bekleniyor]** rozetiyle işaretlidir.
> Hiçbir bilgi uydurulmamıştır. Aşağıdakiler geldikçe `content/company.json` ve ilgili
...
## 6. Teknik
- [ ] **Özel alan adı** (Natro'daki domain) — `public/CNAME` + DNS kaydı için
- [ ] Varsa **vektör (SVG) logo** — PNG'den daha keskin görünür
- [ ] EN/RU/AR çeviri onayı (makine çevirisi işaretli; ana dili konuşan biri gözden geçirmeli)
